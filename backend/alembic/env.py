"""Alembic environment — async runner using the same asyncpg engine as the app."""
import asyncio
...
from app.db.models import Base  # noqa: F401 — imports all models so metadata is populated
